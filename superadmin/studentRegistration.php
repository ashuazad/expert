...
$insertQuery="INSERT INTO admission( lead_id, father_name, email_id, phone, permanent_address, branch_name, regno, roll_no, course, course_fee, total_fee, next_due_date, name, doj, emp_id, due_fee ,lead_userId,status, password)
VALUES (
$lead_id , '$father_name', '$email_id', $phone, '$permanent_address', '$branch_name', '$regno', getNewRollNo(
), '$course', $course_fee, $total_fee, '$next_due_date', '$name', '$doj', '$emp_id', '$due_fee',$lead_userId , '$amd_status' ,md5('$regno'))";

$checkResult = $dbObj->getData(array('*') , "admission" , " phone = $phone AND email_id='$email_id'");
    ...
    <div class="content">      
        ...
        <div class="workplace">
          ...
          <div class="row-fluid">                
                <div class="span12">                    
                    <div class="head">
                        <div >  <div class="isw-cloud"></div>
                        <h1>Admission Form</h1>  <ul class="buttons">                            

                            <li class="active">

                                <a class="isw-settings" href="#"></a>

                                <ul class="dd-list" style="display: block;">
...
<div style="width:60%">
 <div class="row-from clearFix"> 
    ...
    <?php if($existsFlag){ ?> <div class="span6" > Already Exists </div> <?php } ?>
...
<div class="row-from clearFix"> 
    ...
    <select name='branch_name' id='branch_name' style="width:220px; height:30px; background-color:#fff; font-size:12px; font-weight:bold;" required class='inpTxt' placeholder="Branch">
                                                          ...
                                                          ?>
                                                          <option value='<?php echo $brnchName['id'];?>' ><?php echo $brnchName['branch_name'];?></option>
                                                          <?php } ?>
                                               </select>
...
<div class="span6"><input type="text" id="course_fee" name="course_fee" readonly  value="" class='inpTxt' Placeholder="Course Packege"/></div>
</div>
 <div class="row-from clearFix"> 
    <div class="span6"><input type='text'  id="disAmt" name="disAmt" Placeholder="Discount"></div><div class="span6"><input type="text" id="total_fee" name="total_fee" value="" class='inpTxt' Placeholder="Total Fee" required/></div>
    </div> 
</div>
	</section>
