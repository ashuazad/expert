...
if(isset($_POST['sub']) && !isset($_GET['id'])){
unset($_POST['sub']);
$_POST['course']=str_replace(" ","-",$_POST['course']);
$dbObj->dataInsert($_POST, 'course_fee');
header('location:course.php');
}
if(isset($_POST['sub']) && isset($_GET['id'])){
unset($_POST['sub']);
$_POST['course']=str_replace(" ","-",$_POST['course']);
$dbObj->dataUpdate($_POST,'course_fee','course',$_GET['id']);
header('location:course.php');
}
if(isset($_GET['id'])){
$data=$dbObj->getData(array("*"),'course_fee' , "course='".$_GET['id']."'" );
array_shift($data);
//print_r($data);
//$data=$dbObj->getSingleData('course_fee','id',$_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="row-fluid">                
                <div class="span12">                    
                    <div class="head">
                        ...
                        <h1><?php if(isset($_GET['id'])){ echo "Update Course ";}else{ echo "Add Course "; }?></h1>  &nbsp;  
                        </div>                                  
                        <div class="clear"></div>
                    </div>
...
<tr><td><b>Course:<b></td><td><input type="text" name="course" value="<?php if(isset($_GET['id'])){ echo str_replace("-"," ",$data[0]['course']);}?>" /></td></tr>
<tr><td><b>Full Name:<b></td><td><input type="text" name="full_name" value="<?php if(isset($_GET['id'])){ echo $data[0]['full_name'];}?>" /></td></tr>
<tr><td><b>Fee:</b></td><td><input type="text" name="fee" value="<?php if(isset($_GET['id'])){ echo $data[0]['fee'];}?>" /></td></tr>
<tr><td></td><td><input type="submit" name="sub" value="Submit" class="btn" /></td></tr>
</table>
