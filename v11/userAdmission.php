...
<body class="skin-default-dark fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Admission Dashboard</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-center">Today Pending</h4>
                                <div class="gaugejs-box">
                                    <canvas id="foo" class="gaugejs">guage</canvas>
                                </div>
                            </div>
                            <div class="box b-t text-center">
                                <h4 class="font-medium m-b-0 today-pending">12456</h4></div>
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-center">All Pending</h4>
                                <div class="gaugejs-box">
                                    <canvas id="foo2" class="gaugejs">guage</canvas>
                                </div>
                            </div>
                            <div class="box b-t text-center">
                                <h4 class="font-medium m-b-0 all-pending">12456</h4></div>
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-center">All Booking</h4>
                                <div class="gaugejs-box">
                                    <canvas id="foo3" class="gaugejs">guage</canvas>
                                </div>
                            </div>
                            <div class="box b-t text-center">
                                <h4 class="font-medium m-b-0 all-booking">12456</h4></div>
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-center">All Admission</h4>
                                <div class="gaugejs-box">
                                    <canvas id="foo4" class="gaugejs">guage</canvas>
                                </div>
                            </div>
                            <div class="box b-t text-center">
                                <h4 class="font-medium m-b-0 all-adm">12456</h4></div>
                        </div>
                    </div>
                    <!-- Column -->
                </div>
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate>
                                    <div class="form-row form-search">
                                        <div class="col-sm-2">
                                            <input type="date" class="form-control from-date" id="validationCustom01" data-toggle="tooltip" data-placement="top" title="From Date" required="">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="date" class="form-control to-date" id="validationCustom02" data-toggle="tooltip" data-placement="top" title="To Date" required="">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-sm-1">
                                            <input id="" type="text" class="form-control phone" name="phone" value="" placeholder="Phone" data-toggle="tooltip" data-placement="top" title="Phone No Search">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <input id="" type="text" class="form-control amount" name="creditAmt" placeholder="Amount" data-toggle="tooltip" data-placement="top" title="Credit Amount Search">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <select class="custom-select search-fee-status">
                                                <option value="" class="fee-status-default-Opt" selected="">Select Status</option>
                                            </select>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <select id="inputCourses" class="custom-select" name="course">
                                                <option value="" class="course-default-Opt" selected="">Course</option>
                                            </select>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <button class="btn btn-primary search" type="button">GO</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                <button type="button" class="btn btn-primary">                                
                                    No Of Rows
                                    <select id="nofrows" class="font-weight-normal">
                                        <option value="200" selected="">200</option>
                                        <option value="500">500</option>
                                    </select>
                                </button>
                                <button type="button" class="btn btn-primary">
                                            Records <span class="badge badge-light font-weight-bold" id="records">0</span>
                                </button>
                                <button type="button" class="btn btn-danger" id="resetPage">
                            ...
                            <div class="col-md-6">
                                <ul class="pagination justify-content-end">
                                    <li class="page-item active" id="liFirst">
                                        <a class="page-link " href="javascript:void(0)" id="First" tabindex="-1">First</a>
                                    </li>
                                    <li class="page-item active" id="liPrev">
                                        <a class="page-link " href="javascript:void(0)" id="Prev">Previous</a>
                                    </li>
                                    <li class="page-item active"><a class="page-link " id="pageNum" data-page-no="1" href="javascript:void(0)">1</a></li>
                                    <li class="page-item active" id="liNext">
                                        <a class="page-link" href="javascript:void(0)" id="Next">Next</a>
                                    </li>
                                    <li class="page-item active" id="liLast">
                                        <a class="page-link" href="javascript:void(0)" tabindex="-1" id="Last">Last</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                                    ...
                                                                    <table class="table full-color-table full-danger-table hover-table">
                                                                        ...
                                                                        <tbody id="feesRecieptTb">
                                                                            <tr>
                                                                                ...
                                                                                <td>Eichmann</td>
                                                                                <td>@Sonu</td>
                                                                                <td><a href="javascript:void(0);"><i class="ti-printer"></i></a></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Deshmukh</td>
                                                                                <td>30/07/2021</td>
    ...
    <script id="accDueFeesTag" src="dist/js/accAdm.js?_=<?php echo time();?>" data-acc='<?php echo json_encode($_SESSION['user_permission']); ?>'></script>
    <script src="dist/js/custom.min.js"></script>
    <script src="assets/node_modules/sparkline/jquery.sparkline.min.js"></script>
    <script src="assets/node_modules/gauge/gauge.min.js"></script>
    <script src="dist/js/pages/widget-data.js?_=<?php echo time();?>"></script>
