...
<body class="skin-default-dark fixed-layout">
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <span> From Date </span>
                                            <input type="date" class="filter-input from-date" id="validationCustom01" data-toggle="tooltip" data-placement="top" title="" required="" data-original-title="From Date">
                                        </div>
                                        <div class="col-md-2">
                                            <span> To Date </span>
                                            <input type="date" class="filter-input to-date" id="validationCustom02" data-toggle="tooltip" data-placement="top" title="" required="" data-original-title="To Date">
                                        </div>
                                        <div class="col-sm-2">
                                            <span> Branch </span>
                                            <select class="filter-input office-branch"><option value="">Branch</option></select>
                                        </div>
                                        <div class="col-md-2">
                                            <span> Employee </span>
                                            <select class="filter-input office-emp"><option value="">Employee</option></select>
                                        </div>
                                        <div class="col-md-2">
                                            <span> Phone </span>
                                            <input type="text" class="filter-input amd-phone" name="phone" placeholder="Phone">
                                        </div>
                                        <div class="col-md-2">
                                            <button class="btn btn-primary search filter" type="button" style="margin-top: 12px;">GO</button>
                                            <a href="#" class="clear-filter btn btn-info" style="font-weight:500;text-decoration: underline; color: #ff0000;margin-top: 12px;">Clear</a>
                                        </div>
                                    </div>
                                </form>
                                <!-- Filter -->
    ...
    <script src="../dist/js/accDueFees.js?_=<?php echo time();?>" id="dueFee-Script" data-l-type="SUPERADMIN"></script>
</body>
