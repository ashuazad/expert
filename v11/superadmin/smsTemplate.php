...
<body class="skin-default-dark fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <button class="btn btn-info m-r-10 add-template-btn"  data-toggle="modal" data-target="#myModalAdd" >Add Template <i class="fa fa-plus-circle"></i></button>
                            <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body p-b-0">
                                <div class="col-md-12">
                                    ...
                                    <select class="occasion-type form-control">
                                        <option value="DUE_FEES_3_DAY_BEFORE">3 Day Before</option>
                                        <option value="DUE_FEES_ON_DAY">On Due Day</option>
                                        <option value="DUE_FEES_1_DAY_AFTER">After Due Day</option>
                                    </select>    
                                </div>
                                <div class="smsList"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabelAdd">Add Template</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">SMS Type</label>
                                                    <div class="col-md-9">
                                                        <select class="sms-type form-control">
                                                ...
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">SMS Title</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="add-sms-title form-control" placeholder="">
                                                        <small class="form-control-feedback"> It must be unique</small>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">SMSContent</label>
                                                    <div class="col-md-9">
                                                        <textarea name="add-sms-content" class="add-sms-content form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Is Default</label>
                                                    <div class="col-md-9">
                                                        <input type="checkbox" class="sms-template-status js-switch-add" data-size="small" data-color="#89e314" data-secondary-color="#f0f0f0" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div id="myModal" class="modal bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">Edit SMS Template</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body">
                                <form>
    ...
    <script type="module" src="../dist/js/smsTemplate.js?_=<?php echo time();?>"></script>
</body>
</html>