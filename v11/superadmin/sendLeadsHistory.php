...
<body class="skin-default-dark fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Send Leads History</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Send Leads History</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <span style="font-size: 20px;">Send Leads History</span>
                            </div>
                            <div class="card-body p-b-0">
                                <div class="row justify-content-md-left p-b-5 m-l-5 noff-rows-box" style="display: none;">
                                    <div class="col-xs m-r-5 noff-rows-text">

                                    </div>
                                </div>
                                <div class="row justify-content-md-left p-b-10 m-l-5">
                                    <div class="col-xs m-r-5">
                                        <div class="form-group cust-filter-form-group">
                                            <input type="date" id="fromDate" class="form-control fromDate custom-date ivr-call-filter-input" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-xs m-r-5">
                                        <div class="form-group cust-filter-form-group">
                                            <input type="date" id="toDate" class="form-control toDate custom-date ivr-call-filter-input" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-xs m-r-5">
                                        <div class="form-group cust-filter-form-group">
                                            <select id="branchList" class="form-control custom-select branchList ivr-call-filter-input">
                                    ...
                                    <div class="col-xs m-r-5">
                                        <div class="form-group cust-filter-form-group">
                                            <select id="empList" class="form-control custom-select empList">
                                                <option value="">Filter By Employee</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xs">
                                        <button type="button" class="btn waves-effect waves-light btn-primary history-search">GO</button>
    ...
    <script type="module" src="../dist/js/sendLeadsHistory.js?_=<?php echo time();?>"></script>
</body>
</html>