...
<body class="skin-default-dark fixed-layout">
     ...
     <a href="https://www.advanceinstitute.co.in/account/feepayment.php" class="dropdown-item"><i class="ti-wallet"></i> Payment Receipt</a>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <!-- .right-sidebar -->
                <!-- Branch Due Fees Permission -->
                <div class="row">
                    <div class="col-md-12">
                         <div id="modalIdBranch" class="modal" tabindex="-1" role="dialog" aria-labelledby="grid-title" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" style="max-width: 800px">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="grid-title">
                                             <span class="permissionHeader">Permissions of</span> <span class="userNamePerm badge badge-primary">NONE</span>
                                        </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-3">Due Fess</div>
                                            <div class="col-md-6">
                                                <a href="javascript:void(0);" data-toggle="modal" class="viewDueFeesPermission" data-target="#modalViewDueFees" >View Permissions Due Fess</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="modalViewDueFees" class="modal" tabindex="-1" role="dialog" aria-labelledby="grid-title" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" style="max-width: 800px">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="grid-title">
                                            <span class="permissionHeader">Due Fess</span>
                                        </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body container-branchTree">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="branchTree" style="height: 300px;overflow: scroll;">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <button id="btnViewDueFeesSaveTree" class="btn btn-info btn-sm" >Save</button>
                                                <button id="btnViewDueFeesResetTree" class="btn btn-info btn-sm" >Reset</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- Branch Due Fees Permission -->
                <!-- Employee Due Fees Permission -->
                <div class="row">
                    <div class="col-md-12">
                        <div id="modalIdEmployee" class="modal" tabindex="-1" role="dialog" aria-labelledby="grid-title" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="grid-title">
                                            <span class="permissionHeader">Edit View Permission of Other Users Due Fees </span>
                                        </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-header">
                                        <h4 class="modal-title"><span>User Name </span><span class="userNamePerm badge badge-primary">NONE</span></h4>
                                    </div>
                                    <div class="modal-body">
                                        <label>Select Branch</label><select class="form-control perm_branch" name="branch"><option>-Select Branch-</option></select>
                                        <div class="empList" style="margin-top: 10px;">
                                        <ul class="dropdown">
                                            <li></li>
                                        </ul>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success waves-effect save-emp-permission">Save Permission</button>
                                        <button type="button" class="btn btn-info waves-effect close-emp-permission" data-dismiss="modal">Close</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
    ...
    <script type="module" src="../dist/js/alertBox/index.js?_=<?php echo time();?>"></script>
    <script type="module" src="../dist/js/userPermission.js?_=<?php echo time();?>"></script>
</body>
