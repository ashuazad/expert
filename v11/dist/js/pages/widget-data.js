...
$(function () {
    ...
    gauge.maxValue = parseInt(admStatus.today_pending.max); // set max gauge value
    gauge.setMinValue(0);  // Prefer setter over gauge.minValue = 0
    gauge.animationSpeed = 45; // set animation speed (32 is default value)
    //gauge.set(1850); // set actual value 
    gauge.set(parseInt(admStatus.today_pending.value)); // set actual value 
    // ============================================================== 
    // All Pending
    // ============================================================== 
    var opts = {
    ...
    var gauge = new Gauge(target).setOptions(opts); // create sexy gauge!
    //gauge.maxValue = 3000; // set max gauge value
    gauge.maxValue = parseInt(admStatus.all_pending.max);
    gauge.setMinValue(0);  // Prefer setter over gauge.minValue = 0
    gauge.animationSpeed = 45; // set animation speed (32 is default value)
    //gauge.set(508); // set actual value 
    gauge.set(parseInt(admStatus.all_pending.value)); // set actual value 
    // ============================================================== 
    // All Booking
    // ============================================================== 
    var opts = {
    ...
    var gauge = new Gauge(target).setOptions(opts); // create sexy gauge!
    gauge.maxValue = parseInt(admStatus.all_booking.max); // set max gauge value
    gauge.setMinValue(0);  // Prefer setter over gauge.minValue = 0
    gauge.animationSpeed = 45; // set animation speed (32 is default value)
    gauge.set(parseInt(admStatus.all_booking.value)); // set actual value 
    ...
    var gauge = new Gauge(target).setOptions(opts); // create sexy gauge!
    gauge.maxValue = parseInt(admStatus.all_admission.max); // set max gauge value
    gauge.setMinValue(0);  // Prefer setter over gauge.minValue = 0
    gauge.animationSpeed = 45; // set animation speed (32 is default value)
    gauge.set(parseInt(admStatus.all_admission.max)); // set actual value   
