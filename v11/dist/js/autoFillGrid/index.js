...
$("#updateAPI").click(function () {
    $.ajax({
        url: baseUrl + '/ajax/editAutoFillAPIs.php?_=' + currentTime,
        type : 'POST',
...
$("#addAPI").click(function () {
    $.ajax({
        url: baseUrl + '/ajax/addAutoFillAPIs.php?_=' + currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
...
$("body").on("click", ".remove-sms-api", function(){
    $(this).attr('data-id');
    $.ajax({
        url: baseUrl + '/ajax/deleteAutoFillAPIs.php?_=' + currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
...
const updateAPIStatus = (data) => {
    $.ajax({
        url: baseUrl + '/ajax/editAutoFillAPIStatus.php?_=' + currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
