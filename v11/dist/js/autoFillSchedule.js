...
import {renderGrid} from "./autoFillGrid";
...
const setDelayedJob = (objType) => {
    ...
    $.ajax({
        url: baseUrl + '/ajax/setAutoFillJob.php?_=' + defaultConfig.currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
...
const stopDelayedJob = () => {
    $.ajax({
        url: baseUrl + '/ajax/stopAutoFillJob.php?_=' + defaultConfig.currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
        success : function( data ){
...
const getDelayedJobStatus = () => {
    $.ajax({
        url: baseUrl + '/ajax/getAutoFillJobStatus.php?_=' + defaultConfig.currentTime,
        type : 'POST',
        contentType : 'application/json',
        dataType:'json',
        success : function( data ){
